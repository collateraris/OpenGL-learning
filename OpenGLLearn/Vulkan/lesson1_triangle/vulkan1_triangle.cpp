...
int HelloTriangleApplication::main()
{
...
{
	auto vertShaderCode = readFile("Vulkan/lesson1_triangle/shaders/vert.spv");
	auto fragShaderCode = readFile("Vulkan/lesson1_triangle/shaders/frag.spv");
