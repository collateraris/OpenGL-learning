...
namespace lesson_5n3
{
	...
	int lesson_main()
	{
		...
		lesson_1n5::CShader depthDebugShader;
		if (!depthDebugShader.Init("Lessons/5n3_shadow_mapping/shaders/depthDebug.vs", "Lessons/5n3_shadow_mapping/shaders/depthDebug.fs")) return -1;
