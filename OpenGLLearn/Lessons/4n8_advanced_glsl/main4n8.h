...
namespace lesson_4n8
{
	...
	int lesson_main()
	{
		...
		if (!sceneShader.Init("Lessons/4n8_advanced_glsl/shaders/scene.vs", "Lessons/4n8_advanced_glsl/shaders/scene.fs")) return -1;

		lesson_1n5::CShader transparentShader;
		if (!transparentShader.Init("Lessons/4n8_advanced_glsl/shaders/transparent.vs", "Lessons/4n8_advanced_glsl/shaders/transparent.fs")) return -1;

		lesson_1n5::CShader skyboxShader;
		if (!skyboxShader.Init("Lessons/4n8_advanced_glsl/shaders/skybox.vs", "Lessons/4n8_advanced_glsl/shaders/skybox.fs")) return -1;
		
		lesson_1n5::CShader obiwanShader;
		if (!obiwanShader.Init("Lessons/4n8_advanced_glsl/shaders/refraction.vs", "Lessons/4n8_advanced_glsl/shaders/refraction.fs")) return -1;
...
// ------------------------------------------------------------------
		...
		unsigned int uniformBlockIndexTransparent = glGetUniformBlockIndex(transparentShader.GetProgramID(), "Matrices");
		unsigned int uniformBlockIndexSkybox = glGetUniformBlockIndex(skyboxShader.GetProgramID(), "Matrices");
		unsigned int uniformBlockIndexObiwan = glGetUniformBlockIndex(obiwanShader.GetProgramID(), "Matrices");

		glUniformBlockBinding(sceneShader.GetProgramID(), uniformBlockIndexScene, 0);
		glUniformBlockBinding(transparentShader.GetProgramID(), uniformBlockIndexTransparent, 0);
		glUniformBlockBinding(skyboxShader.GetProgramID(), uniformBlockIndexSkybox, 0);
		glUniformBlockBinding(obiwanShader.GetProgramID(), uniformBlockIndexObiwan, 0);
