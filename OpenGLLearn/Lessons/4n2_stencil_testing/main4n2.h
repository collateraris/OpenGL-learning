...
namespace lesson_4n2
{
	...
	int lesson_main()
	{
		...
		if (!sceneShader.Init("Lessons/4n2_stencil_testing/shaders/scene.vs", "Lessons/4n2_stencil_testing/shaders/scene.fs")) return -1;

		lesson_1n5::CShader sigleColorShader;
		if (!sigleColorShader.Init("Lessons/4n2_stencil_testing/shaders/singlecolor.vs", "Lessons/4n2_stencil_testing/shaders/singlecolor.fs")) return -1;
...
// ------------------------------------------------------------------
		...
		while (!glfwWindowShouldClose(window))
		{
			...
			sigleColorShader.setMatrix4fv("view", view);
			...
			sigleColorShader.setMatrix4fv("model", model);
			glDrawArrays(GL_TRIANGLES, 0, 36);
			model = glm::mat4(1.0f);
			model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
			model = glm::scale(model, glm::vec3(1.01f));
