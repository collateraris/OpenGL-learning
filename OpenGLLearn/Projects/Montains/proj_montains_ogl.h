...
namespace proj_mointains_ogl
{
	...
	int lesson_main()
	{
		...
		if (!lightingShader.Init("Projects/Montains/shaders/lighting.vs", "Projects/Montains/shaders/lightingMeshObj.fs")) return -1;

		lesson_1n5::CShader hdrToCubeMapShader;
		if (!hdrToCubeMapShader.Init("Projects/Montains/shaders/hdrToCubeMap.vs", "Projects/Montains/shaders/hdrToCubeMap.fs")) return -1;

		lesson_1n5::CShader envCubeMapShader;
		if (!envCubeMapShader.Init("Projects/Montains/shaders/envCubeMap.vs", "Projects/Montains/shaders/envCubeMap.fs")) return -1;

		lesson_1n5::CShader irradianceMapShader;
		if (!irradianceMapShader.Init("Projects/Montains/shaders/irradianceMap.vs", "Projects/Montains/shaders/irradianceMap.fs")) return -1;

		lesson_1n5::CShader prefilterMapShader;
		if (!prefilterMapShader.Init("Projects/Montains/shaders/prefilterMap.vs", "Projects/Montains/shaders/prefilterMap.fs")) return -1;

		lesson_1n5::CShader integrateBRDFMapShader;
		if (!integrateBRDFMapShader.Init("Projects/Montains/shaders/integrateBRDFMap.vs", "Projects/Montains/shaders/integrateBRDFMap.fs")) return -1;

		lesson_1n5::CShader depthBufferShader;
		if (!depthBufferShader.Init("Projects/Montains/shaders/depthBuffer.vs", "Projects/Montains/shaders/depthBuffer.fs")) return -1;

		lesson_1n5::CShader atmosphereShader;
		if (!atmosphereShader.Init("Projects/Montains/shaders/atmosphere.vs", "Projects/Montains/shaders/atmosphere.fs")) return -1;
